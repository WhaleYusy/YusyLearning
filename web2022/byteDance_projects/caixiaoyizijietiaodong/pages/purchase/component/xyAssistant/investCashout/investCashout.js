...
Page({
  ...
  cashout() {    
    ...
    if (this.data.cashOutMoney == "") {
      tt.showModal({
        title: "提示",
        content: "请输入提现积分，每日限提现一次，每次最高限额10000积分，提现积分限10倍数",
        showCancel: false
      })
      return;
    }
    if (this.data.isTen == false) {
      ...
      if (
        ...
        if (this.data.userInfo.userLevelId == "1" && this.data.userInfo.bi < 200) {
          ...
          tt.showModal({
            title: "提示",
            content: `您是普通会员，输入的积分小于200，不可提现`,
            showCancel: false
          })
        } else if (
          this.data.userInfo.userLevelId == "3" &&
          ...
          tt.showModal({
            title: "提示",
            content: `您是黄金会员，输入的积分小于100，不可提现`,
            showCancel: false
          })
        } else if (
          this.data.userInfo.userLevelId == "5" &&
          ...
          tt.showModal({
            title: "提示",
            content: `您是钻石会员，输入的积分小于100，不可提现`,
            showCancel: false
          })
        } else if (
          this.data.userInfo.userLevelId == "6" &&
