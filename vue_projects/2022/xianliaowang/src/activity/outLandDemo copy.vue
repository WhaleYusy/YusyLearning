                ...
                <div class="search_content_item" v-for="(v,k) in collectionList" :key="k">
                  ...
                  <div class="search_content_item_proMsg">
                    ...
                    <div class="loadBottomContent">
                      <div class="loadLeft">
                        <div class="search_content_item_data">
                          <div class="search_content_item_data_item">
                            ...
                            <!-- <span v-if="v.brandType === '2'" class="tag">国际品牌</span>
                            <span v-if="v.brandType === '1'" class="tag">国内品牌</span> -->
                          </div>
                          <div class="search_content_item_data_item">
                          ...
                          <div class="search_content_item_data_item">
                            ...
                            <span class="itemContent">{{v.remarks || '暂无描述'}}</span>
                          </div>
                        </div>
                        <div class="search_content_item_other">
                          ...
                          <!-- <span>
                            <i
                              style="font-size:12px;padding-right: 3px;"
                      ...
                      <div class="loadRight">
                        <div class="search_content_item_data">
                          <div class="search_content_item_data_item">
                            <span class="itemTitle">封装规格:</span>
                            <span class="itemContent">{{v.spec}}</span>
                          </div>
                          <div class="search_content_item_data_item">
                          ...
                          <div class="search_content_item_data_item">
                            ...
                            <span class="itemContent">{{v.packageDesc || v.projectDesc}}{{v.unitName}}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    <!-- <div
                      class="internationBrand"
                      :class="v.bgType == 0 ? 'i-bg' : ''"
                    >{{v.typeName}}</div>-->
                  </div>
                  ...
                  <div class="search_content_item_due">
                    ...
                    <div class="search_content_item_due_item">
                      <span class="goldWord">￥{{v.goodsPrice || v.ledGoodsPrice}} / {{v.unitName}}</span>
                    </div>
                  </div>
                  <div class="search_content_item_stock">
                    <div class="search_content_item_stock_item">
                      近期预售：
                      <span class="goldWord">{{v.purchaseNum}}{{v.unitName}}</span>
                    </div>
                    <div class="search_content_item_stock_item">
                      现有库存：
                      <span class="goldWord">{{v.stockNum}}</span>
                      {{v.unitName}}
                    </div>
