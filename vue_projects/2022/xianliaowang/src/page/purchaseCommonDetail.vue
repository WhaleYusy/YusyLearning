<template>
  <div class="ReCommonDetailWrap">
    <div class="ReCommonDetail">
      ...
      <div class="proDetailData" v-if="searchType == 1">
        <div class="swiper">
          <div class="swiper-container" id="target-swiper">
            ...
            <div class="swiper-wrapper">
              <div
                class="swiper-slide"
                v-for="(item, index) in this.pageData.detailImages"
                :key="index"
              >
      ...
      <div class="proIntroduceAndPdf" style="margin-top: 20px;">
        ...
        <div class="purchaseCommonDetailContent">
          <div class="pcdc-1">
            <span v-if="searchType == 2">求购:</span>
          ...
          <div class="pcdc-3">
            品牌：{{pageData.materialsBrand==undefined?pageData.field1:pageData.materialsBrand}}
          </div>
          <div class="pcdc-3">
