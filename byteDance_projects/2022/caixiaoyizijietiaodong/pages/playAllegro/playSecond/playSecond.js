...
Page({
  ...
  goNext(){
    if (this.data.submitDataPage2.layerNum !== '' && this.data.submitDataPage2.pcbWide !== null
      ...
      tt.setStorageSync('submitDataPage2', JSON.stringify(this.submitDataPage2));
      global.$ajax('/uac/auth/pcb/preGenPcbInformation', data).then((res) => {
        ...
        if (res.data.message !== '操作成功') {
          ...
          tt.setStorageSync('res', JSON.stringify(res.data.result))
          tt.setStorageSync('msg', JSON.stringify(res.data.message))
          tt.navigateTo({
  ...
  onLoad: function (options) {
    ...
    let item = tt.getStorageSync('submitData1') !== '' ? JSON.parse(tt.getStorageSync('submitData1')) : '' ;
