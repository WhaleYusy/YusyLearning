  ...
  uploadFile() {
    ...
    wx.chooseMessageFile({
      ...
      success(res) {
        ...
        if (tempFilePaths.path.indexOf(".doc") < 0 && tempFilePaths.path.indexOf(".xls") < 0 && tempFilePaths.path.indexOf(".ppt") < 0 && tempFilePaths.path.indexOf(".pdf") < 0 && tempFilePaths.path.indexOf(".docx") < 0 && tempFilePaths.path.indexOf(".xlsx") < 0 && tempFilePaths.path.indexOf(".pptx") < 0){
          wx.showToast({
            title: '上传文件仅支持doc、docx、xls、xlsx、ppt、pptx、pdf格式，其他格式暂不支持',
            icon: 'none'
          })
          return
        }
